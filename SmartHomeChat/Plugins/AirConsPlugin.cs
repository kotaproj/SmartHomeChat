...
public class AirConsPlugin
{
    ...
    {
        new AirConModel { Id = 1, Name = "Living", IsOn = null, Tempature = 26, Mode = AirConMode.Auto },
        new AirConModel { Id = 2, Name = "Bedroom", IsOn = null, Tempature = 26, Mode = AirConMode.Auto },
    };
